                  ...
                  >
                    ...
                    <div className="flex items-center justify-between lg:justify-start gap-3 min-w-0">
                      <div className="flex items-center gap-2.5">
                        ...
                        {isUnifiedPass && (
                          <span className="shrink-0 rounded-md border border-sky-400/50 bg-sky-400/10 px-2 py-0.5 font-mono text-[10px] font-bold text-sky-300" title="Birleşik Füzyon Sinyali">
                            FÜZYON
                          </span>
                        )}

                        {unifiedSources.length >= 2 && (
                          <span className="shrink-0 rounded-md border border-neon-green/50 bg-neon-green/10 px-1.5 py-0.5 font-mono text-[10px] font-bold text-neon-green" title={`Çoklu Teyit: ${unifiedSources.join(" + ")}`}>
                            ⚡ {unifiedSources.length} Kaynak
                          </span>
                        )}
