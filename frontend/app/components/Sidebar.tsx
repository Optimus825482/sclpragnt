...
const MENU = [
    ...
    { href: "/system-health", label: "Sistem Sağlığı", icon: "🩺", desc: "Bağlantı & veri durumu" },
    { href: "/risk", label: "Risk Merkezi", icon: "🛡️", desc: "Pozisyon & risk özeti" },
    { href: "/strategy-comparison", label: "Strateji Karşılaştırma", icon: "⚖️", desc: "Net performans kıyası" },
