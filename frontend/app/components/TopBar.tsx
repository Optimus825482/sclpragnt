...
const labels: Record<string, string> = { "/": "Canlı terminal", "/chat": "Chat merkezi", "/portfolio": "Portföy izleme", "/reports": "Raporlar", "/memory": "LLM hafızası", "/charts": "Grafik", "/symbol-analysis": "Sembol analizi", "/settings": "Ayarlar" };
