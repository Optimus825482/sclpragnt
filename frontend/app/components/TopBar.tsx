...
const labels: Record<string, string> = { "/": "Canlı terminal", "/portfolio": "Portföy yönetimi", "/strategies": "Stratejiler", "/reports": "Raporlar", "/memory": "LLM hafızası", "/backtest": "Backtest", "/charts": "Grafik", "/symbol-analysis": "Sembol analizi", "/settings": "Ayarlar" };
