...
type Config = {
    ...
    ema_vwap_min_volume_ratio: number; ema_vwap_min_adx: number; ema_vwap_require_mtf_alignment: boolean;
...
const STRATEGIES: StrategyMeta[] = [
    { key: "EMA_VWAP_PULLBACK", name: "EMA + VWAP Pullback", icon: "📈", desc: "EMA9/21/50 trendi, VWAP üzeri fiyat, ADX ve hacim teyitli pullback arar.", enabledKey: "ema_vwap_enabled", timeframeKey: "ema_vwap_timeframe", params: [{ key: "ema_short", label: "EMA Kısa", hint: "Hızlı EMA", step: 1, min: 3 }, { key: "ema_mid", label: "EMA Orta", hint: "Pullback EMA", step: 1, min: 5 }, { key: "ema_trend", label: "EMA Trend", hint: "Ana trend EMA", step: 1, min: 10 }, { key: "ema_vwap_min_volume_ratio", label: "Minimum Hacim Oranı", hint: "Son hacim / önceki 20 mum ortalaması", step: 0.1, min: 0 }, { key: "ema_vwap_min_adx", label: "Minimum ADX", hint: "Trend gücü filtresi", step: 1, min: 0 }] },
            ...
            {cfg && (
                <>
                    ...
                    <div className="flex gap-2 flex-wrap">
                        {STRATEGIES.filter(st => st.key === "BB_MFI_MEAN_REVERSION").map((st, i) => {
