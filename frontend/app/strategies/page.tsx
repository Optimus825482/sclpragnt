...
const STRATEGIES: StrategyMeta[] = [
    { key: "EMA_VWAP_PULLBACK", name: "EMA + VWAP Pullback", icon: "📈", desc: "EMA trendi, VWAP üzeri fiyat ve EMA21 pullback dönüşünü birlikte arar.", enabledKey: "ema_vwap_enabled", timeframeKey: "ema_vwap_timeframe", params: [] },
    { key: "BB_SQUEEZE_ORDERFLOW", name: "BB Squeeze + Order-Flow Confirmation", icon: "📦", desc: "Bollinger sıkışması ve kırılımını gerçek bid/ask akışıyla teyit eder.", enabledKey: "bb_squeeze_enabled", timeframeKey: "bb_squeeze_timeframe", params: [] },
    { key: "ORDERFLOW", name: "Order-Flow Imbalance", icon: "🌊", desc: "Emir defterindeki bid/ask dengesizliği ve art arda alış yönlü işlemleri izler.", enabledKey: "orderflow_enabled", timeframeKey: "orderflow_timeframe", params: [] },
    { key: "MOMENTUM", name: "Multi-Timeframe Momentum Ranking", icon: "⚡", desc: "Kısa ve orta vadeli momentumun aynı yönde olmasını ve likidite filtresini arar.", enabledKey: "momentum_enabled", timeframeKey: "momentum_timeframe", params: [] },
    { key: "VWAP_MEAN_REVERSION", name: "VWAP Mean Reversion", icon: "↩️", desc: "VWAP/Bollinger alt bölgesindeki aşırı satımdan dönüşü arar; spotta sabit %2 hedef kullanır.", enabledKey: "mean_reversion_enabled", timeframeKey: "mean_reversion_timeframe", params: [] },
    { key: "KELTNER_BREAKOUT", name: "Keltner Breakout", icon: "🔔", desc: "ATR tabanlı Keltner üst bandı kırılımını hacim ve akış teyidiyle izler.", enabledKey: "keltner_enabled", timeframeKey: "keltner_timeframe", params: [] },
    { key: "CHOP_TREND_FILTER", name: "CHOP Trend Filter", icon: "📐", desc: "Yatay piyasayı CHOP ile eler, trend döneminde RSI momentumunu kullanır.", enabledKey: "chop_enabled", timeframeKey: "chop_timeframe", params: [] },
    { key: "DONCHIAN_BREAKOUT", name: "Donchian Breakout", icon: "🏹", desc: "Son 20 mumun zirvesini hacim ve pozitif akışla kıran sembolleri izler.", enabledKey: "donchian_enabled", timeframeKey: "donchian_timeframe", params: [] },
