...
const TOOL_GROUPS: [string, string[]][] = [
  ...
  ["Araştırma", ["scan_market_snapshots", "detect_15m_upside_candidates", "detect_5m_upside_candidates", "deep_analyze_symbol", "get_data_quality", "get_microstructure_snapshot", "get_regime_snapshot", "calculate_trade_economics", "get_symbol_outcome_profile", "get_realtime_flow", "get_symbol_behavior", "get_subminute_microstructure", "get_historical_slippage", "validate_trade_plan", "run_pattern_universe_research", "get_pattern_research_runs", "save_research_pattern", "list_research_patterns", "list_indicator_research_catalog", "activate_coin", "place_paper_order", "open_llm_paper_trade"]],
  ["Sistem & Hesap", ["get_auto_paper_status", "get_dashboard_summary", "get_monitoring_status", "get_real_account"]],
  ["Canlı kontrol", ["create_market_alert", "update_market_alert", "remove_market_alert", "list_market_alerts", "get_llm_open_position", "update_llm_position_plan", "close_llm_position", "set_llm_symbol_guard", "remove_llm_symbol_guard", "list_llm_symbol_guards", "get_order_status", "cancel_paper_order", "modify_paper_order", "reconcile_portfolio", "deactivate_coin"]],
];
