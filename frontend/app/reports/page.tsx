...
import ChartForecastsTab from "./ChartForecastsTab";
...
function ReportsPageInner(){
 const[tab,setTab]=useState<"overview"|"today"|"signals"|"memory"|"forecasts"|"velocity"|"upside"|"chart_forecasts">("overview"); const[trades,setTrades]=useState<Trade[]>([]); const[signals,setSignals]=useState<any[]>([]); const[decisions,setDecisions]=useState<Decision[]>([]); const[complete,setComplete]=useState(true); const[risk,setRisk]=useState<any>(null); const[forecastReport,setForecastReport]=useState<any>(null); const[forecastLoading,setForecastLoading]=useState(true); const[forecastError,setForecastError]=useState(""); const[upsideReport,setUpsideReport]=useState<any>(null); const[upsideLoading,setUpsideLoading]=useState(true); const[upsideError,setUpsideError]=useState(""); const[velocityReport,setVelocityReport]=useState<any>(null); const[velocityLoading,setVelocityLoading]=useState(true); const[velocityError,setVelocityError]=useState("");
